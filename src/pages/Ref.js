...
const Ref = () => {
  ...
  const copyToClipboard = () => {
    ...
    const reflink = `https://t.me/UIIcoinbot?start=r${id}\n\$UII tokens mining is live! Two is better than one!  Join my squad, and let\'s double the fun (and earnings 🤑)! $UII Power Tap! 🚀`; // refer text 
  ...
  const handleShare = async () => {
    const shareData = {
      title: "Mine $UII tokens now!",
      // eslint-disable-next-line
      url: `https://t.me/UIIcoinbot?start=r${id}\n\ `, // Replace with your link
      text: "$UII tokens mining is live! Two is better than one!  Join my squad, and let's double the fun (and earnings 🤑)! $UII Power Tap! 🚀",
    };
  ...
  const fallbackShare = (shareData) => {
    const encodedText = encodeURIComponent(
      // eslint-disable-next-line
      `${shareData.url} \n\$UII tokens mining is live! Two is better than one!  Join my squad, and let\'s double the fun (and earnings 🤑)! $UII Power Miner! 🚀`
    );
          ...
          <div className="w-full pt-3 justify-center flex-col space-y-3 px-5">
            <div className="w-full flex justify-center">
              <h1 className="font-semibold text-[28px] text-[#ffffffe0] pb-1 text-center">
                Invite friends <br/>& get more $UII
              </h1>
            </div>
