...
const BoostRank = () => {
  ...
  const transaction = (cost) => ({
    ...
    messages: [
      {
        address: "UQAi4p6w3PemFK3YntsAdc8kzv_VdKMxSLS-HSV6JhH7Xi7t",
...
<img src='/dogs.webp' alt='sdfd' className='w-[15px]'/>
          ...
          <span className="text-accent">+{selectedPower.capacity} $UII</span>
              </span>
          <span>Your Purchase of {selectedPower.xx} $UII is successful</span>
        </span>
        <p className="pb-6 text-[15px] w-full text-center">
          Perform more activities or buy more $UII to stay ahead and claim listing giveaway bonues!😎
        </p>
      </div>
      );
...
<img src='/dogs.webp' alt='sdfd' className='w-[70px]'/>
                    ...
                    <p className="pb-6 text-primary text-[14px] px-4 text-center">
                      Get {selectedPower.capacity} $UII and boost your earnings and ranks!
                    </p>
